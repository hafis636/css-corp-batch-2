...
export type APPLY_OFFER_REQUEST = 'APPLY_OFFER_REQUEST';
export type APPLY_OFFER_SUCCESS = 'APPLY_OFFER_SUCCESS';
...
export type ADDRESS_REQUEST = 'ADDRESS_REQUEST';
export type ADDRESS_SUCCESS = 'ADDRESS_SUCCESS';
export type ADDRESS_FAIL = 'ADDRESS_FAIL';
